...
Mye funksjonalitet slik spesifisert i oppgaven er manglende i denne versjonen, da vi brukte for mye tid på å finne ut hvordan flere deler av oppgaven skulle løses. Radiobuttons f.eks. feiler akseptansetesten vår, da de ikke er med på å generere nytt innhold basert på hva som har blitt sjekket av, altså gir de hverken funksjonalitet eller feedback til brukeren. Audioplayeren har heller ingen funksjonalitet knyttet til seg utenom den standard oppførselen.
