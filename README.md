...
Mye funksjonalitet slik spesifisert i oppgaven er manglende i denne versjonen, fordi vi brukte for mye tid på å forsøke å lage funksjoner vi trengte uten at vi fikk det til. Radiobuttons f.eks. feiler akseptansetesten vår, da de ikke er med på å generere nytt innhold basert på hva som har blitt sjekket av, altså gir de hverken funksjonalitet eller feedback til brukeren. Audioplayeren har heller ingen funksjonalitet knyttet til seg utenom den standard oppførselen.
